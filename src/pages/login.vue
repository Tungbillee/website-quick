    ...
    <div class="login-form flex-cl-al gap-50">
      ...
      <div class="form">
        ...
        <form v-on:keyup.enter="onLogin">
          ...
          <div
            class="wrap flex-bw-al gap-5"
            :class="{ active: password_login }"
          >
            ...
            <img
              ...
              v-if="password_login && !showPassword"
              :src="img('eye.svg')"
              alt=""
              @click="showpass"
            />
          ...
          <div
            style="color: red"
            v-if="email_login || password_login"
            class="error mgt-15"
          >
            {{ error_login }}
          </div>
        ...
        <div class="mgt-15 flex-al-jt gap-5">
          Chưa có tài khoản?
          <span style="cursor: pointer" class="text-gradien" @click="register">
            Liên hệ đại lý đăng ký</span
          >
        </div>
      </div>
    </div>
