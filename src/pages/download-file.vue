                    ...
                    <div class="flex gap-20 mgt-40">
                        ...
                        <div class="download flex-cl-bw" @click="downloadWindow">
                            <div>
                                ...
                                <div class="mgt-25">Phù hợp cho tất cả hệ điều hành Window</div>
...
export default {
    ...
    methods: {
        ...
        downloadMacos() {
            window.open("https://download.quickmagic.vn/Quick%20Magic-3.0.5-arm64.pkg", "_blank")
        },
        downloadWindow() {
            window.open("https://download.quickmagic.vn/Quick%20Magic%20Setup%203.0.5.zip", "_blank")
        }
    }
}
</script>
