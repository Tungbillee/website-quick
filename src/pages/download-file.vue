...
export default {
    ...
    methods: {
        ...
        downloadMacos() {
            window.open("https://download.quickmagic.vn/Quick%20Magic-3.0.7-arm64.pkg", "_blank")
        },
        downloadWindow() {
            window.open("https://download.quickmagic.vn/Quick%20Magic%20Setup%203.0.7.zip", "_blank")
        }
    }
}
</script>
